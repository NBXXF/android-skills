---
name: aaaaa-xxf-multi-module-structure
...
4. 如果涉及新增模块落地，继续读取 `aaaaa-xxf-module-scaffold`。
5. 如果涉及公共 API、optional、聚合库或发布边界，继续读取 `aaaaa-xxf-coding-arch` 和 `aaaaa-xxf-risk-gate`。
