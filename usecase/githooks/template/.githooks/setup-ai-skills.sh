#!/usr/bin/env bash
#
# Fallback copy for Git hooks when the repository root setup-ai-skills.sh is absent.
...
resolve_android_skills_dir() {
    ...
    echo "or pass:" >&2
    echo "  ANDROID_SKILLS_DIR=/path/to/android-skills .githooks/xxf_ensure-ai-skills manual" >&2
    exit 1
}
